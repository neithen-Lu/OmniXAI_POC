...
from .utils import GradMixin, grad, guided_bp


class Saliency(ExplainerBase, GradMixin):
    """
    The Saliency method for generating visual explanations.
    If using this explainer, please cite `Simonyan, K., Vedaldi, A., and Zisserman, A. (2013). 
    ...
    def __init__(
        ...
        """
        :param model: The model to explain, whose type can be `tf.keras.Model`.
